...
class BeamSearchDecoderWithLM(BeamSearchDecoder):
    ...
    def __init__(
        ...
        self.lm_token_threshold = lm_token_threshold  # prefix to skip in LM
        ...
        if options.beam_size is not None:
            if options.lm_path is not None:
                self.decoder = BeamSearchDecoderWithLM(
                    ...
                    options.lm_beta,
                    options.lm_eos,
                    options.lm_normalize,
                    options.lm_token_threshold,
                )
            else:
